...
既然我们已经学习了Q-Learning算法，那让我们从头开始实现它，并在两个环境中训练我们的Q-Learning智能体：

1. [Frozen-Lake-v1 (非滑动和滑动版本)](https://www.gymlibrary.dev/environments/toy_text/frozen_lake/) ☃️ : 智能体需要**从起始状态 (initial state - S) 到达目标状态 (goal state - G)**，只能在冰冻的瓷砖 (frozen tiles - F) 上行走，避免掉入洞 (holes - H)。
2. [一个自动驾驶出租车](https://www.gymlibrary.dev/environments/toy_text/taxi/) 🚖 ：智能体需要**学习如何导航**一个城市，**将乘客从A点运送到B点。**

<img src="https://huggingface.co/datasets/huggingface-deep-rl-course/course-images/resolve/main/en/unit3/envs.gif" alt="Environments"/>

借助[排行榜](https://huggingface.co/spaces/huggingface-projects/Deep-Reinforcement-Learning-Leaderboard)，你可以将你的结果与其他同学进行比较，并交流最佳的实现方法，以提高你的智能体的分数。谁会赢得第二单元的挑战呢？

为了通过[认证过程](https://huggingface.co/deep-rl-course/en/unit0/introduction#certification-process)，你需要将你训练好的出租车模型推送到Hub，并**获得>= 4.5的结果**。

要找到你的结果，去[排行榜](https://huggingface.co/spaces/huggingface-projects/Deep-Reinforcement-Learning-Leaderboard)并找到你的模型，**结果 = 平均奖励 - 奖励的标准差**

关于认证过程的更多信息，请查看这一部分 👉 https://huggingface.co/deep-rl-course/en/unit0/introduction#certification-process

你可以在这里查看你的进度 👉 https://huggingface.co/spaces/ThomasSimonini/Check-my-progress-Deep-RL-Course

**要开始动手操作，请点击Open In Colab按钮** 👇 :
...
# 第二单元: 在 FrozenLake-v1 ⛄ 和 Taxi-v3 🚕 中实现Q-Learning

<img src="https://huggingface.co/datasets/huggingface-deep-rl-course/course-images/resolve/main/en/unit3/thumbnail.jpg" alt="Unit 2 Thumbnail">

在这个笔记本中，**你将从头开始编写你的第一个强化学习智能体**，在FrozenLake❄️游戏中使用Q-Learning算法进行训练，并将它与社区中的小伙伴们分享，还可以尝试不同的配置。

⬇️ 下面是一个例子，**你只需要几分钟就能完成**。⬇️
...
我们致力于不断改善我们的教程，所以如果你对教程有一些建议，请在[Github仓库中提交PR](https://github.com/huggingface/deep-rl-class/issues)
...
- 能够使用**Gym**，这是一个环境库。
- 能够从头开始编写一个Q学习智能体。
- 能够**将你训练好的智能体和代码推送到Hub**，并附上一个漂亮的视频回放和一个评估分数 🔥。


## 实践前提 🏗️
在深入学习该笔记之前，你需要:

🔲 📚 **通过阅读第二单元来学习[Q-Learning](https://huggingface.co/deep-rl-course/unit2/introduction)** 🤗

## Q-Learning的简要回顾

- *Q-Learning* **是一种强化学习算法，它**
  - 训练*Q函数*，一个**动作价值函数**，它包含了一个作为内部记忆的*Q-table*，**其中包含了所有状态-动作对的值。**
  - 给定一个状态和动作，我们的Q函数**将在其Q-table中搜索相应的值。**
